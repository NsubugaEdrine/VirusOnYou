...
export default function BottomNavBar() {
  return (
    <nav className="fixed bottom-0 left-0 w-full z-50 flex md:hidden justify-around items-center px-4 py-2 pb-[env(safe-area-inset-bottom,0px)] bg-surface-container-high border-t border-outline-variant shadow-lg rounded-t-xl" aria-label="Mobile navigation">
      {navItems.map((item) => (
        <NavLink
          key={item.to}
          to={item.to}
